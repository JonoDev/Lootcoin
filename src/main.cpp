...
static const int64 nTargetSpacing = 120; // lootcoin: 2 minute blocks
...
string GetWarnings(string strFor)
{
    ...
    {
        nPriority = 2000;
        strStatusloot = strRPC = "WARNING: Displayed transactions may not be correct!  You may need to upgrade, or other nodes may need to upgrade.";
    }
    ...
    // Alerts
    {
        ...
        BOOST_FOREACH(PAIRTYPE(const uint256, CAlert)& item, mapAlerts)
        {
            ...
            if (alert.AppliesToMe() && alert.nPriority > nPriority)
            {
                ...
                strStatusloot = alert.strStatusloot;
            }
        }
    }

    if (strFor == "statusloot")
        return strStatusloot;
    else if (strFor == "rpc")
        return strRPC;
